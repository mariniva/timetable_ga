...
public class Individual {
	...
	public Individual(Timetable timetable) {
		...
		// Loop through groups
		for (GroupsModel group : timetable.getGroupsAsArray()) {
			// Loop through modules
			for (int styleId : group.getStyleIds()) {
				// Add random time
				...
				StylesModel style = timetable.getStyle(styleId);
				newChromosome[chromosomeIndex] = style.getRandomTrainerId();
				chromosomeIndex++;
			}
		}
